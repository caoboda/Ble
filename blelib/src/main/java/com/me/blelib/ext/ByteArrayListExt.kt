...
internal fun ArrayList<Byte>.toHexString(hasSpace: Boolean = true) = this.joinToString("") {
    (it.toInt() and 0xFF).toString(16).padStart(2, '0').toUpperCase(Locale.getDefault()) + if (hasSpace) " " else ""
}

internal fun ArrayList<Byte>.toAsciiString(hasSpace: Boolean = false) =
    this.map { it.toChar() }.joinToString(if (hasSpace) " " else "")

internal fun ArrayList<Byte>.readInt8(offset: Int = 0): Int {
    throwOffsetError(this, offset, 1)
    return this[offset].toInt()
}

internal fun ArrayList<Byte>.readUInt8(offset: Int = 0): Int {
    throwOffsetError(this, offset, 1)
    return this[offset].toInt() and 0xFF
}

internal fun ArrayList<Byte>.readInt16BE(offset: Int = 0): Int {
    throwOffsetError(this, offset, 2)
    return (this[offset].toInt() shl 8) + (this[offset + 1].toInt() and 0xFF)
}

internal fun ArrayList<Byte>.readUInt16BE(offset: Int = 0): Int {
    throwOffsetError(this, offset, 2)
    // 方式一
...
internal fun ArrayList<Byte>.readUInt32BE(offset: Int = 0): Long {
    throwOffsetError(this, offset, 4)
...
internal fun ArrayList<Byte>.readInt32LE(offset: Int = 0): Int {
    throwOffsetError(this, offset, 4)
...
internal fun ArrayList<Byte>.readUInt32LE(offset: Int = 0): Long {
    throwOffsetError(this, offset, 4)
...
// 四字节 float
internal fun ArrayList<Byte>.readFloatBE(offset: Int = 0) = java.lang.Float.intBitsToFloat(this.readInt32BE(offset))

// 四字节 float
internal fun ArrayList<Byte>.readFloatLE(offset: Int = 0) = java.lang.Float.intBitsToFloat(this.readInt32LE(offset))

//
//// 四字节 时间
@SuppressLint("SimpleDateFormat")
internal fun ArrayList<Byte>.readTimeBE(offset: Int = 0, pattern: String = "yyyy-MM-dd HH:mm:ss") =
    SimpleDateFormat(pattern).format(this.readUInt32BE(offset) * 1000)

@SuppressLint("SimpleDateFormat")
internal fun ArrayList<Byte>.readTimeLE(offset: Int = 0, pattern: String = "yyyy-MM-dd HH:mm:ss") =
    SimpleDateFormat(pattern).format(this.readUInt32LE(offset) * 1000)

// 读取ByteArray
internal fun ArrayList<Byte>.readByteArrayBE(offset: Int, byteLength: Int): ArrayList<Byte> {
...
internal fun ArrayList<Byte>.readByteArrayLE(offset: Int, byteLength: Int): ArrayList<Byte> {
    throwOffsetError(this, offset)
    return this.readByteArrayBE(offset, byteLength).reversed() as ArrayList<Byte>
}

// 读取指定范围输出字符串
internal fun ArrayList<Byte>.readStringBE(
    offset: Int,
    byteLength: Int,
    encoding: String = "hex",
...
internal fun ArrayList<Byte>.readStringLE(
    offset: Int,
    byteLength: Int,
    encoding: String = "hex",
    hasSpace: Boolean = encoding.toLowerCase(Locale.getDefault()) == "hex"
...
// ********************************************** 写 **********************************************
internal fun ArrayList<Byte>.writeInt8(value: Int, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset)
    // 无符号Int 执行写入
...
internal fun ArrayList<Byte>.writeInt16BE(value: Int, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 2)
    // 执行写入
...
internal fun ArrayList<Byte>.writeInt16LE(value: Int, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 2)
    // 无符号Int 执行写入
...
internal fun ArrayList<Byte>.writeInt32BE(value: Long, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 4)
    // 无符号Int 执行写入
...
internal fun ArrayList<Byte>.writeInt32LE(value: Long, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 4)
    // 无符号Int 执行写入
    this[offset] = (value and 0xff).toByte()
    this[offset + 1] = (value and 0xff00 ushr 8).toByte()
...
// 写入Float类型
internal fun ArrayList<Byte>.writeFloatBE(value: Float, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 4)
    this.writeInt32BE(java.lang.Float.floatToIntBits(value).toLong(), offset)
    return this
}

internal fun ArrayList<Byte>.writeFloatLE(value: Float, offset: Int = 0): ArrayList<Byte> {
    throwOffsetError(this, offset, 4)
...
@SuppressLint("SimpleDateFormat")
internal fun ArrayList<Byte>.writeTimeBE(time: String, offset: Int = 0, pattern: String = "yyyy-MM-dd HH:mm:ss"): ArrayList<Byte> {
...
@Suppress("RECEIVER_NULLABILITY_MISMATCH_BASED_ON_JAVA_ANNOTATIONS")
@SuppressLint("SimpleDateFormat")
internal fun ArrayList<Byte>.writeTimeLE(time: String, offset: Int = 0, pattern: String = "yyyy-MM-dd HH:mm:ss"): ArrayList<Byte> {
    this.writeInt32LE(SimpleDateFormat(pattern).parse(time).time / 1000, offset)
    return this
}

// 指定位置写入ByteArray
internal fun ArrayList<Byte>.writeByteArrayBE(list: ArrayList<Byte>, offset: Int = 0, length: Int = list.size): ArrayList<Byte> {
    this.writeStringBE(list.toHexString(), offset, length)
    return this
}

internal fun ArrayList<Byte>.writeByteArrayLE(list: ArrayList<Byte>, offset: Int = 0, length: Int = list.size): ArrayList<Byte> {
 ...
 * @encoding  Hex & ASCII
 */
internal fun ArrayList<Byte>.writeStringBE(str: String, offset: Int = 0, encoding: String = "hex"): ArrayList<Byte> {
    throwOffsetError(this, offset)
...
// length: 写入长度
internal fun ArrayList<Byte>.writeStringLE(str: String, offset: Int = 0, encoding: String = "hex"): ArrayList<Byte> {
    when (encoding.toLowerCase(Locale.getDefault())) {
        "hex" -> {
...
internal fun ArrayList<Byte>.writeStringBE(str: String, offset: Int, length: Int, encoding: String = "hex"): ArrayList<Byte> {
...
internal fun ArrayList<Byte>.writeStringLE(str: String, offset: Int, length: Int, encoding: String = "hex"): ArrayList<Byte> {
...
// 无符号int
internal fun readUnsigned(list: ArrayList<Byte>, len: Int, offset: Int, littleEndian: Boolean): Long {
    var value = 0L
